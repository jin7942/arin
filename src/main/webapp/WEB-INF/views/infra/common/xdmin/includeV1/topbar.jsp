        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/code/index"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="fas fa-fw fa-folder"></i> <span>상품관리</span>
                    </a>

                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="/code/itemList">상품목록</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="fas fa-fw fa-cog"></i> <span>코드관리</span>
                    </a>
